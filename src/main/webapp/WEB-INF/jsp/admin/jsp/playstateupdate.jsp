...
<html class="x-admin-sm">
    ...
    <body>
            ...
            <div class="layui-row">
                <form class="layui-form" id="form">
                  ...
                  <div class="layui-form-item">
                      <label for="playname" class="layui-form-label">
                          <span class="x-red">*</span>比赛名称
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" id="playname" name="playname" required="" lay-verify="required"
        ...
        <script>
	        function addPlay() {
	    		var url = "${pageContext.request.contextPath}/addPlay";
	    		var param = $("#form").serialize();
	    		$.post(url, param, function(data) {
	    			if(data.flag==1){
	    				var index = parent.layer.getFrameIndex(window.name); 
	    				parent.layer.close(index);
	    				location.href="${pageContext.request.contextPath}/cate";
	    			}else{
	    				alert(data.msg);
	    			}
