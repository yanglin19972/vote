            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                             <li>
                                <a onclick="xadmin.add_tab('所有投票','jsp/playerT-list.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>选手得票</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('所有投票','jsp/member-list.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户投票</cite></a>
                            </li>
                    ...
                    <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('投票信息','jsp/categories.jsp')">
                                    <i class="iconfont">&#xe6ba;</i>
                                    <cite>选手管理</cite></a>
                            </li>
                    </li>
                    ...
                    <li>
                            <li>
                                <a onclick="xadmin.add_tab('投票信息','jsp/cate.jsp')">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('管理员列表','jsp/admin-list.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>管理员列表</cite></a>
                            </li>
                        </ul>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src='jsp/playerT-list.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
